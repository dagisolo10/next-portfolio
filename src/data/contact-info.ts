...
const contactData = [
    ...
    { label: "LinkedIn", value: "https://linkedin.com/in/dagmawi-solomon-2b350636b", icon: FiLinkedin, color: "text-blue-400" },
    { label: "dagisolo1023@gmail.com", value: "mailto:dagisolo1023@gmail.com", icon: TbMail, color: "text-red-500" },
    { label: "GitHub", value: "https://github.com/dagisolo10", icon: VscGithub, color: "text-foreground" },
